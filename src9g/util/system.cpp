...
const char * const BITCOIN_CONF_FILENAME = "melanin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Melanin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Melanin";
#else
    // Unix-like
    return pathRet / ".melanin";
#endif
#endif
}
