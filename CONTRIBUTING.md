Contributing to Melanin Core
============================

The Melanin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Melanin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/melanin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to melanin-qt
...
The following applies to code changes to the Melanin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Melanin
Network Protocol consensus changes.

Whether a pull request is merged into Melanin Core rests with the project merge
...
Patches that change Melanin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Melanin consensus, it must have been
...
The project leader is the release manager for each Melanin Core release.
