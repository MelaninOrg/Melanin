...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " melanin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  melanin-tx [options] <hex-tx> [commands]  Update hex-encoded melanin transaction\n" +
            "or:     melanin-tx [options] -create [commands]   Create hex-encoded melanin transaction\n" +
            "\n";
