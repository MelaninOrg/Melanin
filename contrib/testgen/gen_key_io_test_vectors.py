...
bech32_templates = [
  ...
  ('mln',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('mln',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('mln',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('mln',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tmln',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tmln',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tmln',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tmln',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tmln',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tmln',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tmln',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tmln',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rmln',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rmln',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rmln',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rmln', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tmln',   17, 32, Encoding.BECH32M, False, False, False),
  ('rmln',  3,  1, Encoding.BECH32M, False, False, False),
  ('mln',   15, 41, Encoding.BECH32M, False, False, False),
  ('tmln',    0, 16, Encoding.BECH32,  False, False, False),
  ('rmln',  0, 32, Encoding.BECH32,  True,  False, False),
  ('mln',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tmln',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rmln',  0, 20, Encoding.BECH32,  False, False, True),
  ('mln',    0, 20, Encoding.BECH32M, False, False, False),
  ('tmln',    0, 32, Encoding.BECH32M, False, False, False),
  ('rmln',  0, 20, Encoding.BECH32M, False, False, False),
  ('mln',    1, 32, Encoding.BECH32,  False, False, False),
  ('tmln',    2, 16, Encoding.BECH32,  False, False, False),
  ('rmln', 16, 20, Encoding.BECH32,  False, False, False),
]
