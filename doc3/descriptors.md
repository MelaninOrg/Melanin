# Support for Output Descriptors in Melanin Core

Since Melanin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `mln1...` for mainnet or `tmln1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Melanin Core wallets, a convenience function `combo` is
