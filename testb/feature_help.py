...
"""Verify that starting melanin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start melanin with -h for help text")
        ...
        self.log.info("Start melanin with -version for version information")
        ...
        self.log.info("Start melanind with -fakearg to make sure it does not start")
